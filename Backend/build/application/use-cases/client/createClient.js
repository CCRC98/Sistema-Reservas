...
var CreateClient = /** @class */ (function () {
    function CreateClient(repository) {
        this.repository = repository;
    }
    CreateClient.prototype.create = function (id, name, email, phone) {
        return __awaiter(this, void 0, void 0, function () {
            var client;
            return __generator(this, function (_a) {
                client = new client_1.Client(new clientId_1.clientId(id), new clientName_1.clientName(name), new clientEmail_1.clientEmail(email), new clientPhone_1.clientPhone(phone));
                return [2 /*return*/, this.repository.createClient(client)];
            });
        });
    };
    return CreateClient;

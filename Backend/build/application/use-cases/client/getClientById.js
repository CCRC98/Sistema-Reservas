...
var GetClientById = /** @class */ (function () {
    function GetClientById(repository) {
        this.repository = repository;
    }
    GetClientById.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var client;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.getClientById(new clientId_1.clientId(id))];
                    case 1:
                        client = _a.sent();
                        if (!client) {

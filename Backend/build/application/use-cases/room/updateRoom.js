...
class UpdateRoom {
    ...
    update(id, number, type, price) {
        return __awaiter(this, void 0, void 0, function* () {
            const room = new room_1.Room(new roomId_1.roomId(id), new roomNumber_1.roomNumber(number), new roomType_1.roomType(type), new roomPrice_1.roomPrice(price));
